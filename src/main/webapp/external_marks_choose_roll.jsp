...
<div class="back"><button onclick="goBack()">Go Back</button></div>
	<div class="content-agileits">
		...
		<div class="left">
			<form action="externalmarksfetchsubjects" method="post" data-toggle="validator">
			<div class="form-group">
					<label for="firstname" class="control-label">Enter Roll Number</label>
					<input type="text" id="firstname" class="form-control" placeholder="Enter Roll Number" name="roll_no" data-error="Enter Your Roll Number" required>
