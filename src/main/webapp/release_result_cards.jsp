...
response.setHeader("Expires", "0");
%>
	<title>Release Result Cards</title>
	...
	<link href="css/release_result_card_style.css" rel="stylesheet" type='text/css' media="all" />
	<!-- /css -->
</head>
...
<body>
	...
	<div class="content-agileits">
		<h1 class="title">Release Result Cards</h1>
		<div class="left">
			<form action="releaseresultcard" method="post" data-toggle="validator">
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" id="lastname" placeholder="Batch" data-error="Enter Batch " name="batch" required>
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" id="lastname" placeholder="Semester" data-error="Enter Batch " name="semester" required>
