...
<head>
	<title>Assign Exam Center</title>
	...
	<link href="css/assign_center_style.css" rel="stylesheet" type='text/css' media="all" />
	<!-- /css -->
...
<div class="back"><button onclick="goBack()">Go Back</button></div>
	<div class="content-agileits">
		<h1 class="title">Assign Exam Center</h1>
		<div class="left">
			<form actionassignexamcenter method="post" data-toggle="validator">
				...
				<div class="form-group">
					<label for="lastname" class="control-label">Exam Center</label>
					<select class="dropdown" name="center">
								<option value="" style="color:#000">Select Center</option>
																	<%for(String co:college){%><option value="<%=co%>"><%=co%></option><%}%><br>
</select><br>
